<template>
    <div id='msgWindow'>
      <div id="header">
        <div id="header-item">
          ...
          <div id="nonhead">
            ...
            <n-icon size="36" color='#000000' id="contactMore" @click="goTo('/home/contact/userinfo/' + friend)">
      ...
      <div id="window">
        ...
        <!-- <div class="msg-container-that">
          <div class="msg">
            这是一条测试消息
          </div>
        </div>
        <div class="msg-container-this">
          <div class="msg">
            这是一条收到测试消息
          </div>
        </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    friend.value = router.currentRoute.value.params.type
    ...
    function loadMessages() {
      ...
      proxy.$axios({
        method: "get",
        url: proxy.$MyServerAPIs.LoadMessages,
        params: {
    ...
    function sendMessage() {
      ...
      proxy.$axios({
        method: "get",
        url: proxy.$MyServerAPIs.SendMessage,
        params: {
          toName: friend.value,
